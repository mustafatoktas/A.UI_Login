...
fun AuthenticationScreenTemplate(
    ...
    Column(
        ...
        InputField(
            leadingImageVector = Icons.Outlined.PersonOutline,
        ...
        InputField(
            leadingImageVector = Icons.Outlined.Key,
...
private fun InputField(
    ...
    TextField(
        ...
        keyboardOptions = KeyboardOptions(
            imeAction = if (isEmailInput) ImeAction.Next else ImeAction.Done,
            keyboardType = if (isEmailInput) KeyboardType.Email else KeyboardType.Text
        )
    )
}
